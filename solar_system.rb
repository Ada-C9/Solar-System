...
# my_planets = [
# {name: "Mercury", diameter: "4,879", moons: "0", temperature: "-173-427"},
# {name: "Venus", diameter: "12,104", moons: "o", temperature: "462"},
# {name: "Earth", diameter: "12,756", moons: "1", temperature: "-88 to 58"},
# {name: "Mars", diameter: "6,805", moons: "2", temperature: "-63"},
# {name: "Jupiter", diameter: "142,984", moons: "67", temperature: "-108"},
# {name: "Hoth", diameter: "7,200", moons: "3", temperature: "-60"}
# ]
